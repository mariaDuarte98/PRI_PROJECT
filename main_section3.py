...
def undirected_page_rank(q, D, p, sim, threshold, selection, priors=None):
    ...
    if selection == 'bm25':
        ...
        docs = boolean_query(topic_processed, D, 3)  # choose to use query of k = 3
...
# did not use these two, since our graph was undirected, as we simply made each edge in two, one in each direction
...
#build_graph(test_xmls, 'cosine', 0.2)

#res = undirected_page_rank('R101',test_xmls,10,'cosine',0.2, 'bm25','degree_cent')
#print(res)
